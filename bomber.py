        ...
        try:
            ...
            if cc == "91":
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To shadowcracker97@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        print("==================================================================")
...
if nm == 0:
    ...
    print("              This Bomber Was recreated BY shadowcracker credits to owner@speedx !! ")
    print("==================================================================")
